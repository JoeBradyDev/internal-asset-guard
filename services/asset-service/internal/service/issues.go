...
func (s *AssetServer) GetIssue(ctx context.Context, req *proto.GetIssueRequest) (*proto.IssueResponse, error) {
...
func (s *AssetServer) ListIssuesByAsset(ctx context.Context, req *proto.ListIssuesRequest) (*proto.ListIssuesResponse, error) {
	rows, err := s.Queries.GetIssuesByAssetID(ctx, req.AssetId)
	if err != nil {
		return nil, err
	}

	var issues []*proto.IssueResponse
	for _, row := range rows {
		issues = append(issues, &proto.IssueResponse{
			Id:              row.ID,
			AssetId:         row.AssetID,
...
func (s *AssetServer) UpdateIssue(ctx context.Context, req *proto.UpdateIssueRequest) (*proto.IssueResponse, error) {
	...
	return s.GetIssue(ctx, &proto.GetIssueRequest{Id: updated.ID})
}

// DeleteIssue removes an issue.
func (s *AssetServer) DeleteIssue(ctx context.Context, req *proto.DeleteIssueRequest) (*proto.Empty, error) {
	// Note: Ensure you have DeleteAssetIssue in your sql queries
	err := s.Queries.DeleteAssetIssue(ctx, req.Id)
	return &proto.Empty{}, err
}

// Internal helper to map core db.AssetIssue to proto.IssueResponse
func (s *AssetServer) mapIssueToProto(i db.AssetIssue) *proto.IssueResponse {
	return &proto.IssueResponse{
		Id:              i.ID,
		AssetId:         i.AssetID,
